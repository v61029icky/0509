...
*/
  //oop
        ...
        return;
          ...
          if (p5j.loaded === 1){
            ...
            L.circle([val.geometry.coordinates[1], val.geometry.coordinates[0]], { // 緯度在前面
                ...
                fillOpacity: 0.3,
                stroke: false, // 取消邊線
                radius: val.properties.mag*50000 // 強度 乘上大小單位為公尺
    ...
    $('#lbutton').click(()=>{
        let url = 'https://spreadsheets.google.com/feeds/list/1RNzqbG5J_gzRHzz9IsurGbUd1ACVl5j1T7Yo3YZYtf0/1/public/values?alt=json';
        p5j.loaded=0;
        //console.log(url);
        p5j.httpGet(url, 'jsonp', false, function(response) {
    ...
    $('#ubutton').click(()=>{
        if(p5j.arrarea.length>0){
          ...
          let exeurl = 'https://script.google.com/macros/s/AKfycbzP6Pa8eqa-8gwT1ZBc49mQMvGVa1OMMqSSb6Ep-lqLnBUITHm3/exec';          
          let editurl = 'https://docs.google.com/spreadsheets/d/1RNzqbG5J_gzRHzz9IsurGbUd1ACVl5j1T7Yo3YZYtf0/edit#gid=0';
